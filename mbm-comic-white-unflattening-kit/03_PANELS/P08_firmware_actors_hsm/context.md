# P08 — Firmware actors + state machines

## 1) Goal (viewer takeaway)
One strong visual sentence: **MCU as stage/city; actors exchanging event packets; state machine as layered sculpture; minimal text.**
