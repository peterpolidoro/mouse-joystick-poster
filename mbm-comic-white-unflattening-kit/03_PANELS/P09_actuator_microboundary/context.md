# P09 — Single actuator micro-boundary (stepper or brake)

## 1) Goal (viewer takeaway)
One strong visual sentence: **Macro close-up inside bubble; power in to mechanical output; info feedback out; waste heat hint.**
