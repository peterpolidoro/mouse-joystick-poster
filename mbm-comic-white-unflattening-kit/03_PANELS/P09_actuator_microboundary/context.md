...
- A small icosahedron boundary token around the actuator.
- Power tether (amber) entering electrically; mechanical output implied (shaft/torque) possibly as a subtle tether.
- Information tether(s) (cyan) for command in and sensor feedback out (encoder, limit switch, current sense).
