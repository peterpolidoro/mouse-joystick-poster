# P10 — Theory strip: power ↔ information ↔ entropy
...
- This file: `03_PANELS/P10_theory_entropy/context.md` (the one you’re reading)

### Panel‑specific REQUIRED uploads
- [ ] 1–3 sentences (max) of the theory message you want this strip to imply (not necessarily to render as text).

### Panel‑specific OPTIONAL uploads (helps accuracy)
- [ ] Any diagrams or notes about cybernetic thermodynamics you want referenced.

### Text info to paste into the chat (if you want accuracy)
- Optional symbols you prefer (ΔS, entropy, ‘heat’, ‘constraints’).

---

## 5) Output spec (so it drops into the template cleanly)
- **Panel physical size in template:** ~43.54×6.33 inches
- **Aspect ratio (approx):** 6.875 (W/H)
- **Suggested render size:** 4096×596 px (or the **largest** your image tool allows at this aspect ratio)
