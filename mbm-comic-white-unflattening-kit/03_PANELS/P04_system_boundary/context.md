# P04 — Top-level system boundary

## 1) Goal (viewer takeaway)
One strong visual sentence: **Big boundary bubble around full instrument stack; power in (amber), info out (cyan) toward artifacts; optional dissipation haze.**
