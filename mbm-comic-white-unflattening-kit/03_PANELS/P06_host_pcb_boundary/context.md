# P06 — Host ↔ PCB boundary (protocol + power)

## 1) Goal (viewer takeaway)
One strong visual sentence: **Laptop/host and PCB; cyan bidirectional comms; amber power into PCB; show ports as rings on bubble surface.**
