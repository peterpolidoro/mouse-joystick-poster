...
- A icosahedron boundary token representing the overall pipeline.
- Multiple thin **information** tethers (cyan accent) radiating from the boundary to a *constellation* of artifacts:
